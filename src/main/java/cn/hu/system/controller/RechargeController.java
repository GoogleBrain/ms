...
public class RechargeController extends BaseController {
	...
	public String index(Model model) {
		...
		return "system/recharge/recharge";
	}

	@RequestMapping("recharge/checkUserName")
	@ResponseBody
	...
	@RequestMapping("recharge/getUser")
	@ResponseBody
	...
	@RequiresPermissions("recharge:list")
	@ResponseBody
	public Map<String, Object> userList(QueryRequest request,Recharge recharge) {
		return super.selectByPageNumSize(request, () -> this.rechargeService.findAllRecharge(recharge));
	}

	@RequestMapping("recharge/excel")
	@ResponseBody
	...
	@RequestMapping("recharge/regist")
	@ResponseBody
	...
	@Log("修改用户")
	@RequiresPermissions("recharge:update")
	...
	@Log("删除用户")
	@RequiresPermissions("recharge:delete")
	...
	@RequestMapping("recharge/checkPassword")
	@ResponseBody
	...
	@RequestMapping("recharge/updatePassword")
	@ResponseBody
	...
	@RequestMapping("recharge/profile")
	public String profileIndex(Model model) {
		...
		model.addAttribute("user", user);
		return "system/recharge/rechargeprofile";
	}

	@RequestMapping("recharge/getUserProfile")
	@ResponseBody
	...
	@RequestMapping("recharge/updateUserProfile")
	@ResponseBody
	...
	@RequestMapping("recharge/changeAvatar")
	@ResponseBody
