...
public class CommentController extends BaseController {
    ...
    @RequestMapping("comment/checkUserName")
    @ResponseBody
    ...
    @RequestMapping("comment/getUser")
    @ResponseBody
    ...
    @RequestMapping("comment/checkPassword")
    @ResponseBody
    ...
    @RequestMapping("comment/updatePassword")
    @ResponseBody
    ...
    @RequestMapping("comment/profile")
    public String profileIndex(Model model) {
        ...
        model.addAttribute("user", user);
        return "system/comment/commentProfile";
    }

    @RequestMapping("comment/getUserProfile")
    @ResponseBody
    ...
    @RequestMapping("comment/updateUserProfile")
    @ResponseBody
    ...
    @RequestMapping("comment/changeAvatar")
    @ResponseBody
