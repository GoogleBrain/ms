...
public class RebateController extends BaseController {
    ...
    @Log("新增用户")
    @RequiresPermissions("rebate:add")
    @RequestMapping("rebate/add")
    @ResponseBody
    ...
    @Log("修改用户")
    @RequiresPermissions("rebate:update")
    @RequestMapping("rebate/update")
    @ResponseBody
    ...
    @Log("删除用户")
    @RequiresPermissions("rebate:delete")
    @RequestMapping("rebate/delete")
    @ResponseBody
    ...
    @RequestMapping("rebate/checkPassword")
    @ResponseBody
    ...
    @RequestMapping("rebate/updatePassword")
    @ResponseBody
    ...
    @RequestMapping("rebate/updateUserProfile")
    @ResponseBody
    ...
    @RequestMapping("rebate/changeAvatar")
    @ResponseBody
