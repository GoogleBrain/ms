...
public class OrdersController extends BaseController {
    ...
    @Log("新增用户")
    @RequiresPermissions("orders:add")
    ...
    @RequestMapping("orders/checkPassword")
    @ResponseBody
    ...
    @RequestMapping("orders/updatePassword")
    @ResponseBody
    ...
    @RequestMapping("orders/updateUserProfile")
    @ResponseBody
    ...
    @RequestMapping("orders/changeAvatar")
    @ResponseBody
