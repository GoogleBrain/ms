...
public class StorageController extends BaseController {
	...
	@RequestMapping("storage/checkUserName")
	@ResponseBody
	...
	@RequestMapping("storage/getUser")
	@ResponseBody
	...
	@Log("新增用户")
	@RequiresPermissions("storage:add")
	...
	@RequestMapping("storage/checkPassword")
	@ResponseBody
	...
	@RequestMapping("storage/updatePassword")
	@ResponseBody
	...
	public String profileIndex(Model model) {
		...
		model.addAttribute("user", user);
		return "system/storage/storageProfile";
	}

	@RequestMapping("storage/getUserProfile")
	@ResponseBody
	...
	@RequestMapping("storage/updateUserProfile")
	@ResponseBody
	...
	@RequestMapping("storage/changeAvatar")
	@ResponseBody
