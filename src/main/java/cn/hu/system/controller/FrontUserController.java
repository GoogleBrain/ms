...
public class FrontUserController extends BaseController {
    ...
    public String index(Model model) {
        ...
        return "system/frontuser/user";
    }

    @RequestMapping("frontuser/checkUserName")
    @ResponseBody
    ...
    @RequestMapping("frontuser/getUser")
    @ResponseBody
    ...
    @RequestMapping("frontuser/excel")
    @ResponseBody
    ...
    @RequestMapping("frontuser/regist")
    @ResponseBody
    ...
    @Log("更换主题")
    @RequestMapping("frontuser/theme")
    @ResponseBody
    ...
    @Log("新增用户")
    @RequiresPermissions("frontuser:add")
    @RequestMapping("frontuser/add")
    @ResponseBody
    ...
    @Log("修改用户")
    @RequiresPermissions("frontuser:update")
    @RequestMapping("frontuser/update")
    @ResponseBody
    ...
    @Log("删除用户")
    @RequiresPermissions("frontuser:delete")
    @RequestMapping("frontuser/delete")
    @ResponseBody
    ...
    @RequestMapping("frontuser/checkPassword")
    @ResponseBody
    ...
    @RequestMapping("frontuser/updatePassword")
    @ResponseBody
    ...
    @RequestMapping("frontuser/profile")
    public String profileIndex(Model model) {
        ...
        model.addAttribute("user", user);
        return "system/frontuser/profile";
    }

    @RequestMapping("frontuser/getUserProfile")
    @ResponseBody
    ...
    @RequestMapping("frontuser/updateUserProfile")
    @ResponseBody
    ...
    @RequestMapping("frontuser/changeAvatar")
    @ResponseBody
