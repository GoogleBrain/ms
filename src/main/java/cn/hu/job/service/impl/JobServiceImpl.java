package cn.hu.job.service.impl;
...
import cn.hu.common.annotation.CronTag;
import cn.hu.common.service.impl.BaseService;
import cn.hu.job.dao.JobMapper;
import cn.hu.job.domain.Job;
import cn.hu.job.service.JobService;
import cn.hu.job.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("cn.hu.job.task");
