package cn.hu.common.aspect;

import com.google.common.collect.ImmutableList;

import cn.hu.common.annotation.Limit;
import cn.hu.common.domain.LimitType;
import cn.hu.common.exception.LimitAccessException;
import cn.hu.common.util.IPUtils;
...
/**
 * 接口限流注解，示例见 cn.hu.common.controller.TestController
 */
@Aspect
@Component
public class LimitAspect {
    ...
    @Pointcut("@annotation(cn.hu.common.annotation.Limit)")
