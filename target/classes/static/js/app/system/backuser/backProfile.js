...
$(function () {
    ...
    $(".default_avatars_list").find("img").each(function () {
        ...
        $this.on("click", function () {
            ...
            $.post(ctx + "backuser/changeAvatar", {"imgName": target_src}, function (r) {
                if (r.code === 0) {
    ...
    $("#update-profile .btn-save").click(function () {
        ...
        if (flag) {
            $.post(ctx + "backuser/updateUserProfile", $userProfileForm.serialize(), function (r) {
                if (r.code === 0) {
...
function editUserProfile() {
    $.post(ctx + "backuser/getUserProfile", {"userId": userId}, function (r) {
        if (r.code === 0) {
